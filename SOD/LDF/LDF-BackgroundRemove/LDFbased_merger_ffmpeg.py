...
import time
from vf_convert import video2frame, frame2video, get_fps, video2frame_ffmpeg
from new_video_merge import video_merger
...
if __name__=='__main__':
    ...
    print("Getting target fps...")
    fps = get_fps('../input_video/' + sys.argv[1], '../input_video/' + sys.argv[2])
    print("Cutting frames for original video...")
    ori_fps, ori_frameCount, ori_size, ori_frame_path = video2frame_ffmpeg('../input_video/' + sys.argv[1], '../data/ori_frame_temp/image', fps)
    print("Frame saved in " + ori_frame_path)
    print("Cutting frames for background video...")
    bg_fps, bg_frameCount, bg_size, bg_frame_path = video2frame_ffmpeg('../input_video/' + sys.argv[2], '../data/bg_frame_temp', fps)
    print("Frame saved in " + bg_frame_path)
